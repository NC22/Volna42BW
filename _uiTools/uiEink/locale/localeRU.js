var ENVLOCALE = {
    ...
    "cui_download_preview_as_bin" : "Картинку (BIN)",
    "cui_download_preview_as_json" : "Картинку & Настройки (JSON)",
    
    "cui_send_to_screen" : "Вывести на экран",
    "cui_preview" : "Предпросмотр",
  
    "cui_convert_mbestmatch" : "По ближайшим соответствиям",
    "cui_convert_invert_bg" : "Инвертировать цвет фона",
    "cui_convert_matkinson" : "Алгоритм Аткинсона (дизеринг)",
    "cui_convert_matkinson_coefficient" : "Интенсивность",
    "cui_convert_gs" : "Доп. преобразования в оттенки серого",
    "cui_convert_matkinson_drawp" : "Учитывать доп. цвета",
    "cui_convert_offset_x" : "Смещение по X",

    "cui_filelist_not_loaded" : "Список файлов не загружен",
    "cui_filelist_empty" : "Файлов стилей нет",
    "cui_filelist_save_cui" : "Сохранить оформление",
    "cui_filelist_save_cui_nothing" : "Нечего сохранять",
    "cui_filelist_confirm_remove" : "Подтвердите удаление файла",
    "cui_filelist_remove" : "Удалить",
    "cui_filelist_format" : "Очистить память",
    "cui_filelist_format_confirm" : "Подтвердите полную очистку памяти",
    "cui_filelist_left" : "Занято",
    "cui_filelist_enter_filename" : "Введите название файла",
    "cui_filelist_readfile_fail" : "Ошибка файловой системы устройства. Невозможно открыть файл",
    "cui_filelist_adownload" : "Скачать",
    "cui_filelist_apreview" : "Превью",
    "cui_filelist_ascreen" : "На экран",
    
    "cui_sending_screen_data" : "Загружаю данные... ",
    "cui_sending_fail" : "Нет обратной связи с устройством.",
    "cui_sending_reboot_required" : "Перезагружаюсь для переинициализации буфера экрана!",

    "cui_reset_screen" : "Сбросить экран",
