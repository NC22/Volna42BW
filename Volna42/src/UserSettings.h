...
/* 
	...
	Actual version of font converter tool can be found here https://42volna.ru/tools/fontconverter
...
const unsigned int cdConfigVersion PROGMEM = 1003;             // [1003-20000] Увеличить значение для корректного обновления по воздуху без полной перезагрузки (штамп версии важен для корректного сброса значений RTC памяти, возможно для сравнения структуры конфига в постоянной памяти устройства в будущем)
