...
const char productVersion[] PROGMEM = "0.97";
...
const unsigned int cdConfigVersion PROGMEM = 1015;             // [1003-20000] Увеличить значение для сброса кэша веб-версии \ корректного обновления без полной перезагрузки
