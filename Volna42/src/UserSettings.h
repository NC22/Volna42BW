...
const char productVersion[] PROGMEM = "0.94";
...
const unsigned int cdConfigVersion PROGMEM = 1011;             // [1003-20000] Увеличить значение для сброса кэша веб-версии \ корректного обновления без полной перезагрузки
