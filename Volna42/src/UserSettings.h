...
const char productVersion[] PROGMEM = "0.93";
...
const uint8_t cfgUpdateMinutes PROGMEM = 1;            // 0-1 | Update clock widget every minute (actual period is defined in PARTIAL_UPDATE_INTERVAL)
...
const unsigned int cdConfigVersion PROGMEM = 1009;             // [1003-20000] Увеличить значение для сброса кэша веб-версии \ корректного обновления без полной перезагрузки
