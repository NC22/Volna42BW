...
const unsigned int cdConfigVersion PROGMEM = 1007;             // [1003-20000] Увеличить значение для сброса кэша веб-версии \ корректного обновления без полной перезагрузки
