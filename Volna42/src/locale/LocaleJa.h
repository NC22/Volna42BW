...
const char locShortMonday[] PROGMEM = "月";
const char locShortTuesday[] PROGMEM = "火";
const char locShortWednesday[] PROGMEM = "水";
const char locShortThursday[] PROGMEM = "木";
const char locShortFriday[] PROGMEM = "金";
